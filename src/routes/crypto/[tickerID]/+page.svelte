<script lang="ts">
  ...
  $: {
    if ($cryptoTicker && typeof window !== "undefined") {
...
<svelte:head>
  ...
  <title>
    ...
    {$displayCompanyName} ({$cryptoTicker}) Stock Price, Quote & News ·
    stocknear
  </title>

  <meta
    name="description"
    content={`Get a real-time ${$displayCompanyName} (${$cryptoTicker}) stock price quote with breaking news, financials, statistics, charts and more.`}
  />
  <!-- Other meta tags -->
  <meta
    property="og:title"
    ...
    <div class="md:flex md:justify-between md:divide-x md:divide-slate-800">
      ...
      <div class="pb-12 md:pb-20 w-full sm:pr-6 xl:pr-0">
        <div class="xl:pr-10">
          ...
          {#if CryptoKeyInformation && $screenWidth <= 1022}
            ...
            <div class="w-full mt-8 m-auto sm:p-6">
              ...
              <CryptoKeyInformation {cryptoProfile} />
            </div>
          {/if}
