...
<section class="w-full overflow-hidden m-auto">
  ...
  >
    ...
    Dividend Aristocrats are companies in the S&P500 index that have been
    raising their dividends every year for 25 or more years. This is a list of
  ...
  <div class="flex flex-row items-end justify-end w-fit ml-auto mt-5 mb-2">
    <DownloadData
      {data}
      rawData={data?.getDividendAristocrats}
