    ...
    <div class="w-full flex flex-col md:flex-row py-6">
      ...
      <div class="flex-1 mb-2 sm:mb-0">
        ...
        <ul class="list-reset mb-6">
          ...
          <li class="mt-2 inline-block mr-2 md:block md:mr-0" >
            <a rel="noopener noreferrer" target="_blank" href="https://www.ko-fi.com/stocknear" class="no-underline sm:hover:underline text-gray-100  sm:hover:text-blue-400">Donation ❤</a>
          </li>
        </ul>
      </div>
